    ...
    public BasicTypeDefine reconvert(Column column) {
        ...
        switch (column.getDataType().getSqlType()) {
            ...
            case TIMESTAMP:
                ...
                break;
            case TIMESTAMP_TZ:
                Integer tzScale = column.getScale();
                if (tzScale != null && tzScale > MAX_TIMESTAMP_SCALE) {
                ...
                if (tzScale != null && tzScale > 0) {
                    builder.columnType(String.format("%s(%s)", PG_TIMESTAMP_TZ, tzScale));
                } else {
