...
/**
 * The implementation of {@link org.apache.seatunnel.api.source.SourceReader.Context} for flink 1.20
 * engine.
 */
@Slf4j
public class FlinkSourceReaderContext implements SourceReader.Context {
    ...
    public FlinkSourceReaderContext(SourceReaderContext readerContext, SeaTunnelSource source) {
        ...
        log.info(
                "FlinkSourceReaderContext initialized for subtask: {}",
    ...
    public MetricsContext getMetricsContext() {
        try {
            StreamingRuntimeContext runtimeContext = getStreamingRuntimeContext(readerContext);
    ...
    private static StreamingRuntimeContext getStreamingRuntimeContext(
        ...
        try {
            ...
            try {
                ...
                log.error("Failed to get StreamingRuntimeContext", ex);
                throw new IllegalStateException("Initialize flink context failed", ex);
            }
        } catch (Exception e) {
            log.error("Failed to get StreamingRuntimeContext", e);
